    ...
    constructor() {
        ...
        this.messages = {
            ...
            'DE': {
                ...
                itemScore: 'Punkte',
                statHP: 'LP',
                statHPPercent: 'LP-Prozentsatz',
                statATK: 'Angriff',
                statATKPercent: 'Angriff-Prozentsatz',
                statDEF: 'Verteidigung',
                statDEFPercent: 'Verteidigung-Prozentsatz',
                statCritRate: 'KT',
            ...
            'ID': {
                ...
                itemScore: 'Skor',
                statHP: 'HP',
                statHPPercent: 'Persentase HP',
                statATK: 'ATK',
                statATKPercent: 'Persentase ATK',
                statDEF: 'DEF',
                statDEFPercent: 'Persentase DEF',
                statCritRate: 'CRIT Rate',
                statCritDMG: 'CRIT DMG',
                statElementalMastery: 'Elemental Mastery',
                statEnergyRecharge: 'Energy Recharge',
            ...
            'TH': {
                ...
                itemScore: 'คะแนน',
                statHP: 'พลังชีวิต',
                statHPPercent: 'พลังชีวิต เปอร์เซ็นต์',
                statATK: 'พลังโจมตี',
                statATKPercent: 'พลังโจมตี เปอร์เซ็นต์',
                statDEF: 'พลังป้องกัน',
                statDEFPercent: 'พลังป้องกัน เปอร์เซ็นต์',
            ...
            'TR': {
                ...
                itemScore: 'Skor',
                statHP: 'Can',
                statHPPercent: 'Can yüzdesi',
                statATK: 'Saldırı',
                statATKPercent: 'Saldırı yüzdesi',
                statDEF: 'Savunma',
                statDEFPercent: 'Savunma yüzdesi',
            ...
            'VN': {
                ...
                itemScore: 'Điểm',
                statHP: 'HP',
                statHPPercent: 'Phần trăm HP',
                statATK: 'Tấn Công',
                statATKPercent: 'Phần trăm Tấn Công',
                statDEF: 'Phòng Ngự',
                statDEFPercent: 'Phần trăm Phòng Ngự',
